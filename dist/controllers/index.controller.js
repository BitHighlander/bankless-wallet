...
var IndexController = /** @class */ (function (_super) {
    ...
    */
    ...
    /*
        get Address
    */
    IndexController.prototype.address = function () {
        return __awaiter(this, void 0, void 0, function () {
            var tag, address, e_2, errorResp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tag = TAG + " | address | ";
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, pioneer.getAddress()];
                    case 2:
                        address = _a.sent();
    ...
    /*
        send to address
    */
    IndexController.prototype.sendToAddress = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var tag, address, amount, result, e_3, errorResp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, pioneer.sendToAddress(address, amount)];
                    case 2:
                        result = _a.sent();
    ...
    __decorate([
        (0, tsoa_1.Get)('/address')
    ], IndexController.prototype, "address");
    __decorate([
        (0, tsoa_1.Post)('/sendToAddress'),
        __param(0, (0, tsoa_1.Body)())
    ], IndexController.prototype, "sendToAddress");
